...
If you implemented the middleware outlined in the [Session cookies in Astro](/lucia-next-docs-starlight/sessions/cookies/astro) page, you can get the current session and user from `Locals`.
