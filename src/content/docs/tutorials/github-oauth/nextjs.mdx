...
Use the `getCurrentSession()` function from the [Session cookies in Next.js](/lucia-next-docs-starlight/sessions/cookies/nextjs) page to get the current user and session.
