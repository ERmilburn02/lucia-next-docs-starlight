...
If you implemented the middleware outlined in the [Session cookies in SvelteKit](/lucia-next-docs-starlight/sessions/cookies/sveltekit) page, you can get the current session and user from `Locals`.
