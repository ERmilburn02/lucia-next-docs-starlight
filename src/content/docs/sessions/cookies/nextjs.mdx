---
title: "Session cookies in Next.js"

---

import { Aside } from '@astrojs/starlight/components';

<Aside>This page builds upon the API defined in the [Basic session API](/lucia-next-docs-starlight/sessions/basic-api) page.</Aside>
...
<Aside>Lucia v3 used `auth_session` as the session cookie name.</Aside>
...
<Aside>While Lucia v3 recommended setup extended session cookie lifetime, it did not avoid the revalidation issue.</Aside>
...
<Aside title="Note from author">It's possible that pilcrow meant `getCurrentSession` here.</Aside>