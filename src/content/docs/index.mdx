...
It should also be noted that these docs aren't automatically updated, but I'll try to keep them up to date as much as possible. The site is currently in sync with [`lucia-auth/next@4d9d27e`](https://github.com/lucia-auth/next/tree/4d9d27ed1d7a98baf5d2fdfad06d0367d4309c3e).
</Aside>
