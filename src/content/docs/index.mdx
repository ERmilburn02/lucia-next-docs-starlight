...
Hi, it's me, ERmilburn02, the one that rebuilt these docs using Starlight. When you see blocks with this title, it's a note directly from me, that didn't exist in the original Lucia Next Docs. It's usually reserved only for parts that are broken or missing.

It should also be noted that these docs aren't automatically updated, but I'll try to keep them up to date as much as possible. The site is currently in sync with [`lucia-auth/next@4ccc2a6`](https://github.com/lucia-auth/next/commit/4ccc2a68a89ad2e1205a3b49053f283b746ad21e).
</Aside>
