...
It should also be noted that these docs aren't automatically updated, but I'll try to keep them up to date as much as possible. The site is currently in sync with [`lucia-auth/next@242e0b2`](https://github.com/lucia-auth/next/commit/242e0b2b702f21dda23d92cc69dcf97b3dbee11f).
</Aside>
