...
<Aside title="Note from author">Hi, it's me, ERmilburn02, the one that rebuilt these docs using Starlight. When you see blocks with this title, it's a note directly from me, that didn't exist in the original Lucia Next Docs. It's usually reserved only for parts that are broken or missing (which you'll see a lot in Next.js areas)</Aside>
